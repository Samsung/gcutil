...
It is not recommended to use std::vector, because its `std::vector::end` points next space of the last element which makes GC think it as a non-collectible space!
